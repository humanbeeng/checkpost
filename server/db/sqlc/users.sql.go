...
insert into users (
	name, plan ,email
) values ($1, $2, $3) returning id, name, plan, email, created_at
`
...
func (q *Queries) CreateUser(ctx context.Context, arg CreateUserParams) (User, error) {
	row := q.db.QueryRow(ctx, createUser, arg.Name, arg.Plan, arg.Email)
	var i User
	err := row.Scan(
		&i.ID,
		&i.Name,
...
select id, name, plan, email, created_at from users where id = $1 limit 1
`
